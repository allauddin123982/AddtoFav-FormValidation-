  ...
  return (
    ...
    <div className='max-w-[450px] mx-auto   absolute top-18 right-0 rounded-xl bg-gray-800 text-white z-10'>
        ...
        <form action="" className='p-5' onSubmit={handleValidation}>
            ...
            <input type="text" className='border w-96 p-1 text-black' name="name" onChange={handleInput} />
            {
                errors.name && <p style={{color:"red"}} >{errors.name}</p>
            }
            <p className='font-bold text-xl mt-5'>Email</p>
            <input type="text" className='border w-96 p-1 text-black' name="email" onChange={handleInput} />
            {
                errors.email && <p style={{color:"red"}}>{errors.email}</p>
            }
            <p className='font-bold text-xl mt-5'>Password</p>
            <input type="password" className='border w-96 p-1 text-black' name="password" onChange={handleInput}/>
            {
                errors.password && <p style={{color:"red"}}>{errors.password}</p>
            }
            <button className='rounded bg-blue-500 p-2 w-32 mt-5 text-xl '>Submit</button>
